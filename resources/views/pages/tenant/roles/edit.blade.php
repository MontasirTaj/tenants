...
@section('content')
        ...
        <div class="col-xl-8 mx-auto">
            <div class="card tenant-page-header-card">
                <div class="card-body d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                    <div>
                        <h2 class="tenant-page-header-title">{{ __('app.roles_title') }}</h2>
                        <p class="tenant-page-header-subtitle">تعديل الدور</p>
                    </div>
                    <div class="tenant-page-header-actions mt-3 mt-md-0">
                        <a href="{{ route('tenant.subdomain.roles.index', ['subdomain' => $sub]) }}"
    ...
    <div class="row">
        <div class="col-xl-8 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-3">تعديل الدور</h4>
                    <form method="POST"
                        action="{{ route('tenant.subdomain.roles.update', ['subdomain' => $sub, 'role' => $role->id]) }}">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
